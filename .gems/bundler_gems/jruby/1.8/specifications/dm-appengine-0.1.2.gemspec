...
Gem::Specification.new do |s|
  ...
  s.autorequire = %q{dm-appengine-adapter}
  s.date = %q{2010-09-06}
  s.description = %q{A DataMapper adapter for Google App Engine}
  s.email = ["ribrdb@google.com", "ninja@slaphack.com"]
  s.extra_rdoc_files = ["README.rdoc", "LICENSE"]
  s.files = ["LICENSE", "README.rdoc", "Rakefile", "spec/dm-appengine_spec.rb", "spec/dm-is-entity_spec.rb", "spec/spec_helper.rb", "lib/dm-appengine/properties/rating.rb", "lib/dm-appengine/properties/list.rb", "lib/dm-appengine/properties/string.rb", "lib/dm-appengine/properties/key.rb", "lib/dm-appengine/properties/native.rb", "lib/dm-appengine/properties.rb", "lib/dm-appengine/appengine_resource.rb", "lib/dm-appengine/is_entity.rb", "lib/dm-appengine-adapter.rb"]
